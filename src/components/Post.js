...
const Post = (props) => {
            ...
            updateForm =   
                        ...
                        <form className="editForm" onSubmit={updateCurrentPost}>
                            <p>Update the current post</p>
                                ...
                                <label htmlFor="cover" className="cover">Para darle un presupuesto y entender de que se trata el trabajo, sube una foto/video</label>
    ...
    if(timer){
        currentPost = <div className="loader">Se esta subiendo su solicitud...</div>
    }else{
